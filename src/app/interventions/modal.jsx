          ...
          <div className="w-[400px] h-[400px] ">
              <div className="bg-white p-5 rounded-3xl text-black font-Varela">
                ...
                <div className="mb-1 flex">
                  ...
                  <Image src="/trash.svg" width={30} height={18} className="mr-2 cursor-pointer" onClick={handleTrashClick} alt="Icono de eliminación"/>
                </div>
                <div className="mb-1 flex items-center">
                  <p className="text-blue-500 inline mr-2"><strong>Beneficiario:</strong></p>
                  <p className="inline"><strong>{selectedIntervention.name}</strong></p>
                </div>
                <div className="mb-1 flex items-center">
                  <p className="text-blue-500 inline mr-2"><strong>Fecha de atención:</strong></p>
                  <p className="inline"><strong>{selectedIntervention.fecha}</strong></p>
                </div>
                <div className="mb-1 flex items-center">
                  <p className="text-blue-500 inline mr-2"><strong>Tipología:</strong></p>
                  <p className="inline"><strong>{selectedIntervention.tipología}</strong></p>
                </div>
                <div className="mb-1 flex items-center">
                  <p className="text-blue-500 inline mr-2"><strong>Técnico:</strong></p>
                  <p className="inline"><strong>{selectedIntervention.técnico}</strong></p>
                </div>
                <div className="mb-1 flex items-center">
                  <p className="text-blue-500 inline mr-2"><strong>Motivo:</strong></p>
                  <p className="inline"><strong>{selectedIntervention.motivo}</strong></p>
                </div>
                <p className="text-blue-500"><strong>Observaciones:</strong></p>
                <p><strong>-{selectedIntervention.observaciones}</strong></p>
              </div>
          </div>

...
export default function Interventions() {
	...
	const interventions = [
		...
		},
		{
			...
			motivo: 'Motivo 3',
			observaciones:
				'Observación 3 almacena los cambios en una pila temporal. Puedes tener múltiples stashes y aplicarlos en el orden que desees. También puedes eliminar elementos de la pila de stashes cuando ya no los '
		}
	]
	...
	const interventionsList = interventions.map(i => (
		<tr key={i.id} onClick={() => openModal(i)} data-testid="intervention-row">

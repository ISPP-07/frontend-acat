...
export default function CreateModal({ isVisible, closeModal }) {
	...
	return (
		<div className="fixed top-0 left-0 bg-gray-600 bg-opacity-50 h-full w-full flex items-center justify-center z-50">
			<div className="flex justify-end">
				<button className="text-gray-500 text-xl" onClick={closeModal}>
					X
				</button>
			</div>
